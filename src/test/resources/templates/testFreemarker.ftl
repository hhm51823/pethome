...
<#--                        <a href="'http://123.207.27.208' + ${resources.split(',')[0]}"><img src="'http://123.207.27.208' + ${resources.split(',')[0]} + '_350x350'"-->
<#--                                                        alt="细节展示放大镜特效"-->
<#--                                                        rel="'http://123.207.27.208' + ${resources.split(',')[0]}" class="jqzoom"/></a>-->
                    </div>
                    <ul  class="tb-thumb" id="thumblist">
<#--                        <li v-for="(path,index) in resources" class="tb-selected">-->
<#--                            <div class="tb-pic tb-s40">-->
<#--                                <a href="#"><img :src="'http://123.207.27.208' + path + '_60x60'"-->
<#--                                                 :mid="'http://123.207.27.208' + path + '_350x350'"-->
<#--                                                 :big="'http://123.207.27.208' + path"></a>-->
<#--                            </div>-->
<#--                        </li>-->
<#--                        <#list pet.resources.split(',') as path>-->
                ...
                <div class="tb-detail-list">
                    ...
                    <div class="tb-detail-price">
                        <li class="price iteminfo_price">
                            <dt>促销价</dt>
                            <dd><em>¥</em><b class="sys_item_price">${saleprice * 2}</b></dd>
                        </li>
                        <li class="price iteminfo_mktprice">
                            <dt>原价</dt>
                            <dd><em>¥</em><b class="sys_item_mktprice">${saleprice * 5}</b></dd>
                        </li>
                        <div class="clear"></div>
                    </div>
